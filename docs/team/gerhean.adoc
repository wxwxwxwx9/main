...
** Project management:
*** Standardised the Intellij IDEA code formatter, in order to make the code base more uniform and to
meet the checkstyle requirements (https://github.com/AY1920S2-CS2103T-F10-2/main/pull/221[#221].

** Review/mentoring contributions:
*** Was the main technical adviser, and suggested implementation methods for several features.
**** Examples:
https://github.com/AY1920S2-CS2103T-F10-2/main/pull/82[#82],
https://github.com/AY1920S2-CS2103T-F10-2/main/pull/118[#118],
https://github.com/AY1920S2-CS2103T-F10-2/main/pull/216[#216]
...
** Community:
*** Contributed to forum discussions (examples: https://github.com/nus-cs2103-AY1920S2/forum/issues/74[#74])
