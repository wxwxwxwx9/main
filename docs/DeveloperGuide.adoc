...
* **Alternative 1 (current choice)**: Create a separate internship diary dedicated to handle archived internship applications.
...
* **Alternative 2**: Manipulate the current view of the internship diary to accommodate the archival mechanism.
