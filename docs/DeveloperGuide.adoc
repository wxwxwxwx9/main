...
** Cons: Premature Optimisation.


* **Alternative 1**: Have `InternshipDiaryParser` have different modes depending
...
* **Alternative 2**: Make a confirmation window which freeze the main window.
