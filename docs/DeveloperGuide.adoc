...
Internship Diary uses link:https://gradle.org/[Gradle] for build automation.

See link:https://ay1920s2-cs2103t-f10-2.github.io/main/UsingGradle.html[UsingGradle] for more details.

=== Continuous Integration

Internship Diary uses link:https://travis-ci.org/[Travis CI] for continuous integration.

See  link:https://ay1920s2-cs2103t-f10-2.github.io/main/UsingTravis.html[UsingTravis] for more details.

=== Coverage Reporting

Internship Diary uses link:https://coveralls.io/[Coveralls] to track code coverage.

See link:https://ay1920s2-cs2103t-f10-2.github.io/main/UsingCoveralls.html[UsingCoveralls] for more details.
...
. Generate a JAR file link:https://ay1920s2-cs2103t-f10-2.github.io/main/UsingGradle.html#creating-the-jar-file[using Gradle].

. Tag the repo with the appropriate version number. e.g. v2.0

. link:https://help.github.com/en/github/administering-a-repository/managing-releases-in-a-repository[Create a new release using GitHub] and upload the JAR file you created.
