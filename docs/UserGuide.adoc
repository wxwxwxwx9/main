...
* `list` +
`archive s/rejected` +
Archives all the internship applications with the `rejected` status in the main list.
// end::archive[]
...
Unarchives all the internship applications with the `rejected` status in the archival list.
// end::unarchive[]
