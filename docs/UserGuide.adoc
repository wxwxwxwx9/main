...
Before you proceed, here are some important information you should know.
...
| Priority | w/ | No | 1 | Must be an integer from 0 to 10 (inclusive).
...
Deletes the specified internship application from the current list (main or archival). +
