...
Shows a list of all internship applications that you have applied to. +
Format: `list`
...
Deletes the specified internship application from the diary. +
Format: `delete INDEX`
...
* `list` +
`delete 2` +
Deletes the 2nd internship application in the list.
* `find Google` +
`delete 1` +
Deletes the 1st internship application in the results of the `find` command.
