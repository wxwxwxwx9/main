...
public enum Status {
    ...
    private static final String[] validStatuses = new String[] {
            "active", "inactive", "plan_to_apply", "application_done",
            "interview_scheduled", "interview_done", "accepted", "rejected"
    };
