...
public class JsonAdaptedInternshipTest {
    ...
    private static final String INVALID_ISARCHIVED = "s";
    ...
    private static final String VALID_ISARCHIVED = GOOGLE.isArchived().toString();
    ...
    public void toModelType_invalidCompany_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(INVALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_nullCompany_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(null, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, INVALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, null,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        INVALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        null, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, INVALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, null, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_invalidApplicationDate_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, INVALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_nullApplicationDate_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, null, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_invalidRole_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, INVALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_nullRole_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, null, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_invalidPriority_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, INVALID_PRIORITY, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_nullPriority_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, null, VALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_invalidStatus_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, INVALID_STATUS, VALID_ISARCHIVED);
    ...
    public void toModelType_nullStatus_throwsIllegalValueException() {
        JsonAdaptedInternship internship =
                new JsonAdaptedInternship(VALID_COMPANY, VALID_ROLE, VALID_ADDRESS, VALID_PHONE,
                        VALID_EMAIL, VALID_APPLICATION_DATE, VALID_PRIORITY, null, VALID_ISARCHIVED);
